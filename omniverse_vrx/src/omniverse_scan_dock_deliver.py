...
from omniverse_vrx.msg import MissionGoal, MissionAction
from omniverse_vrx.cfg import ScanDockDeliverConfig
from omniverse_vrx.perception_module import ColorSequenceDetector, BayDetector
from omniverse_vrx.planning_module import Mission
from omniverse_vrx.control_module import PolarController
from omniverse_vrx.common_utilities import quaternion_to_euler, euler_to_quaternion, cartesian_to_polar, euclidean_distance, normalize_angle, local_to_global_tf, gps_to_enu, enu_to_gps
...
if __name__ == "__main__":
    rospy.init_node('omniverse_scan_dock_deliver', anonymous = True)
    ...
    # Action client
    scan_dock_deliver_node.action_client = actionlib.SimpleActionClient('omniverse_mission_manager', MissionAction)
