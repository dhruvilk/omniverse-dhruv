...
from omniverse_vrx.cfg import TeleoperationConfig
from omniverse_vrx.common_utilities import constrain
...
-------------------------------------
omniverse - WAM-V Teleoperation Panel
-------------------------------------
...
if __name__=="__main__":
    ...
    # Teleoperation node
    rospy.init_node('omniverse_teleoperation')
