...
from omniverse_vrx.cfg import ScenePerceptionConfig
from omniverse_vrx.perception_module import BuoyDetector, GateDetector

################################################################################

'''
`BuoyDetector` and `GateDetector` classes are defined in omniverse_vrx.perception_module
'''

################################################################################
if __name__ == '__main__':
    rospy.init_node('omniverse_scene_perception')
