...
from omniverse_vrx.cfg import MissionManagerConfig
from omniverse_vrx.msg import MissionResult, MissionFeedback, MissionAction
from omniverse_vrx.planning_module import Mission, DubinsPath, PathPlanner
from omniverse_vrx.control_module import PIDController
from omniverse_vrx.common_utilities import enu_to_gps, gps_to_enu, normalize_angle, quaternion_to_euler
    ...
    def mission_manager(self, goal):
        ...
        while not self.mission_complete:
            ...
            if self.action_server.is_preempt_requested():
                if self.debug:
                    print("{}: Preempted!".format('omniverse_mission_manager'))
                    print()
        ...
        if self.mission_complete:
            ...
            if self.debug:
                print("{}: Succeeded!".format('omniverse_mission_manager'))
                print()
...
if __name__ == "__main__":
    rospy.init_node('omniverse_mission_manager', anonymous = True)
    ...
    # Action server
    mission_manager_node.action_server = actionlib.SimpleActionServer('omniverse_mission_manager', MissionAction, execute_cb = mission_manager_node.mission_manager, auto_start = False)
