...
from omniverse_vrx.cfg import TaskManagerConfig

def config_callback(config, level):
    return config

if __name__ == '__main__':
    rospy.init_node('omniverse_task_manager', anonymous = True)
    ...
    # Get path to omniverse_vrx ROS package
    rospack = rospkg.RosPack()
    pkg_path = rospack.get_path('omniverse_vrx')
