...
from omniverse_vrx.cfg import GymkhanaChallengeConfig
from omniverse_vrx.planning_module import FiniteStateMachine
from omniverse_vrx.common_utilities import gps_to_enu, enu_to_gps, quaternion_to_euler, euler_to_quaternion, heading_to_bearing
...
if __name__ == "__main__":
    rospy.init_node('omniverse_gymkhana_challenge', anonymous = True)
    ...
    # Action client
    gymkhana_challenge_node.action_client = actionlib.SimpleActionClient('omniverse_mission_manager', MissionAction)
